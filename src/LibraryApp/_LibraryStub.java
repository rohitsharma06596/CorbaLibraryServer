...
/**
* LibraryApp/_LibraryStub.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from Library.idl
* Friday, March 8, 2019 7:16:00 o'clock PM EST
*/

public class _LibraryStub extends org.omg.CORBA.portable.ObjectImpl implements LibraryApp.Library
{
  ...
  public String removeItem (String managerID, String itemID, int quantity, boolean completeRemove)
  {
            ...
            try {
                ...
                $out.write_string (itemID);
                $out.write_long (quantity);
                $out.write_boolean (completeRemove);
                $in = _invoke ($out);
                String $result = $in.read_string ();
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                ...
                return removeItem (managerID, itemID, quantity, completeRemove        );
            } finally {
                _releaseReply ($in);
            }
  } // removeItem
  ...
  public boolean load_server (String server_name)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("load_server", true);
                ...
                return load_server (server_name        );
            } finally {
                _releaseReply ($in);
            }
  } // load_server
  ...
  public String addToWait (String parm, String itemID, String userID)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("addToWait", true);
                $out.write_string (parm);
                $out.write_string (itemID);
                $out.write_string (userID);
                $in = _invoke ($out);
                String $result = $in.read_string ();
                ...
                return addToWait (parm, itemID, userID        );
            } finally {
                _releaseReply ($in);
            }
  } // addToWait
